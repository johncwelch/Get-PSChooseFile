...
function buildChooseFileCommand {
     Param (
...
#build the command
$chooseFileCommand = buildChooseFileCommand -chooseFilePrompt "Choose a file or files" -multipleSelectionsAllowed $true -defaultLocation "/users/jwelch/Desktop" -showInvisibles $true -showPackageContents $true
