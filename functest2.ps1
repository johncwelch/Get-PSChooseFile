...
#this new take removes the need for the custom class and building the massive array of extenstions/filetypes. 
#instead, when passed an array of extensions/file types, the function runs the switch case statement to build 
#a list of identifiers which are then converted to an AppleScript list. This is *significantly faster than the old way
